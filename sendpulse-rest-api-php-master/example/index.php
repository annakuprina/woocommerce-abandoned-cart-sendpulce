...
require get_template_directory() . "/sendpulse-rest-api-php-master/src/ApiInterface.php";
require get_template_directory() . "/sendpulse-rest-api-php-master/src/ApiClient.php";
require get_template_directory() . "/sendpulse-rest-api-php-master/src/Storage/TokenStorageInterface.php";
require get_template_directory() . "/sendpulse-rest-api-php-master/src/Storage/FileStorage.php";
require get_template_directory() . "/sendpulse-rest-api-php-master/src/Storage/SessionStorage.php";
require get_template_directory() . "/sendpulse-rest-api-php-master/src/Storage/MemcachedStorage.php";
require get_template_directory() . "/sendpulse-rest-api-php-master/src/Storage/MemcacheStorage.php";

...
define("ABANDON_CART_URL", get_option( 'ac_lite_cart_abandoned_abandon_cart_url' ));
define("PURCHASE_URL", get_option( 'ac_lite_cart_abandoned_purchase_url' ));
...
class ApiClient implements ApiInterface
{
    ...
    protected function sendEvent($data = array(), $useToken = true)
    {
        $url = ABANDON_CART_URL;
    ...
    protected function sendPurchase($data = array(), $useToken = true)
    {
        $url = PURCHASE_URL;
        $curl = curl_init();
    ...
    public function createEvent($eventData)
    {
        ...
        $requestResult =  $this->sendEvent($data);
        return $this->handleResult($requestResult);
     }
       


    public function createPurchase($purchaseData)
    {
        $data = $purchaseData;
        $requestResult =  $this->sendPurchase($data);
        return $this->handleResult($requestResult);
    }
